...
export const BLOG_LIST: BlogPost[] = BLOG_SLUGS.map(
  (slug) => BLOG_POSTS[slug]
);

/** Display dates for blog index cards */
export const BLOG_PUBLISHED: Record<BlogSlug, string> = {
  "why-most-business-websites-fail": "January 2025",
  "how-much-should-a-website-cost-in-2026": "February 2025",
  "how-long-does-seo-take": "February 2025",
  "what-makes-a-high-converting-website": "March 2025",
  "local-seo-complete-guide": "March 2025",
  "marketing-funnels-explained-small-businesses": "April 2025",
  "seo-vs-paid-ads-which-to-choose": "April 2025",
};
