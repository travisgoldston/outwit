      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {bullets.map((item) => (
            <div
              key={item.title}
              className="flex flex-col rounded-2xl border border-white/10 bg-white/5 p-6 text-left backdrop-blur-sm transition-all hover:border-white/20 hover:bg-white/[0.07]"
            >
