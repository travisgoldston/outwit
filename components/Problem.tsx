...
export default function Problem() {
  return (
    <section className="border-t border-white/5 bg-[#111111] px-6 py-20 text-slate-100 lg:px-8 lg:py-28">
      <div className="mx-auto max-w-5xl">
        <h2 className="text-center text-3xl font-bold tracking-tight text-white sm:text-4xl">
          Why most businesses struggle online.
        </h2>
        <p className="mx-auto mt-6 max-w-2xl text-center text-lg leading-[1.75] text-slate-200">
        ...
        <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {bullets.map((item) => (
            <div
              key={item.title}
              className="flex flex-col rounded-2xl border border-slate-700 bg-[#151515] p-6 text-left shadow-sm transition-all hover:border-neon-orange/70"
            >
        ...
        <p className="mt-14 text-center text-xl font-semibold text-slate-100">
