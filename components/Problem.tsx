...
export default function Problem() {
  return (
    <section className="border-t border-white/5 bg-[#FAFAFA] px-6 py-20 text-slate-900 lg:px-8 lg:py-28">
      <Reveal className="mx-auto max-w-5xl rounded-3xl border border-slate-200 bg-white p-8 sm:p-10">
        ...
        <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {bullets.map((item, idx) => (
            <Reveal key={item.title} delayMs={60 * idx}>
              <div className="flex flex-col rounded-2xl border border-slate-200 bg-white p-6 text-left shadow-sm transition-all hover:border-neon-orange/60">
