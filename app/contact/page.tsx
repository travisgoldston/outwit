  ...
  return (
    <div className="bg-vibe-bg px-6 py-16 lg:px-8 lg:py-24">
      ...
      <div className="mx-auto mt-16 max-w-4xl grid gap-10 lg:grid-cols-[minmax(0,2fr),minmax(0,1.2fr)]">
        <section className="rounded-2xl border border-white/10 bg-white/5 p-7 backdrop-blur-sm">
          ...
          <form className="mt-6 space-y-4">
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                ...
                <input
                  type="text"
                  className="mt-2 w-full rounded-md border border-white/15 bg-transparent px-3 py-2 text-sm text-white outline-none transition-colors focus:border-neon-orange/80"
            ...
            <div>
              ...
              <textarea
                className="mt-2 min-h-[120px] w-full rounded-md border border-white/15 bg-transparent px-3 py-2 text-sm text-white outline-none transition-colors focus:border-neon-orange/80"
        ...
        <aside className="space-y-6 rounded-2xl border border-white/10 bg-transparent p-1 lg:p-0">
          <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6">
            <h3 className="text-sm font-semibold text-white">Prefer email?</h3>
