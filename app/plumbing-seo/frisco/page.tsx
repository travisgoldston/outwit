...
export const metadata: Metadata = {
  title: "Outwit — Plumbing SEO in Frisco",
  description:
    "Plumbing SEO in Frisco for companies that want more emergency calls and service bookings from high-intent local search. Start with the Growth Plan.",
};

export default function PlumbingSeoFriscoPage() {
  return (
    <div className="bg-[#FAFAFA] px-6 py-16 text-slate-900 lg:px-8 lg:py-24">
      <div className="mx-auto max-w-4xl text-center">
        <h1 className="text-4xl font-bold tracking-tight text-slate-900 sm:text-5xl">
          Plumbing SEO in Frisco: capture local demand and convert it into calls.
        </h1>
        <p className="mx-auto mt-6 max-w-3xl text-lg leading-relaxed text-slate-600">
          Outwit helps Frisco plumbing companies show up for the searches that matter—urgent
      ...
      <div className="mx-auto mt-16 max-w-5xl space-y-10">
        ...
        <section className="rounded-3xl border border-slate-200 bg-white px-8 py-10 text-center shadow-sm">
          <h2 className="text-2xl font-semibold tracking-tight text-slate-900 sm:text-3xl">
            Want a focused plan for Frisco plumbing leads?
          </h2>
