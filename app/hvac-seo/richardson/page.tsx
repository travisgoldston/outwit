...
export const metadata: Metadata = {
  title: "Outwit — HVAC SEO in Richardson",
  description:
    "HVAC SEO in Richardson for companies that want more inbound calls and booked jobs from high-intent local search. Start with the Outwit Growth Plan.",
};

export default function HvacSeoRichardsonPage() {
  return (
    <div className="bg-[#FAFAFA] px-6 py-16 text-slate-900 lg:px-8 lg:py-24">
      <div className="mx-auto max-w-4xl text-center">
        <h1 className="text-4xl font-bold tracking-tight text-slate-900 sm:text-5xl">
          HVAC SEO in Richardson: win high-intent searches and turn them into booked jobs.
        </h1>
        <p className="mx-auto mt-6 max-w-3xl text-lg leading-relaxed text-slate-600">
          Outwit helps Richardson HVAC companies get found when homeowners are ready to hire—then
      ...
      <div className="mx-auto mt-16 max-w-5xl space-y-10">
        <section className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm sm:p-10">
          <h2 className="text-2xl font-semibold tracking-tight text-slate-900 sm:text-3xl">
            The real fight in Richardson isn’t traffic—it’s intent
          </h2>
        ...
        <section className="rounded-3xl border border-slate-200 bg-white px-8 py-10 text-center shadow-sm">
          <h2 className="text-2xl font-semibold tracking-tight text-slate-900 sm:text-3xl">
            Want a simple, specific plan for Richardson?
          </h2>
