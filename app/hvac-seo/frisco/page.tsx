...
export const metadata: Metadata = {
  title: "Outwit — HVAC SEO in Frisco",
  description:
    "HVAC SEO in Frisco for companies that want more inbound calls and booked jobs from high-intent local search. Start with the Outwit Growth Plan.",
};

export default function HvacSeoFriscoPage() {
  return (
    <div className="bg-[#FAFAFA] px-6 py-16 text-slate-900 lg:px-8 lg:py-24">
      <div className="mx-auto max-w-4xl text-center">
        <h1 className="text-4xl font-bold tracking-tight text-slate-900 sm:text-5xl">
          HVAC SEO in Frisco: win high-intent searches and turn them into booked jobs.
        </h1>
        <p className="mx-auto mt-6 max-w-3xl text-lg leading-relaxed text-slate-600">
          Outwit helps Frisco HVAC companies get found when homeowners are ready to hire—then
          removes friction so the next step is a call, a form, or a booked appointment.
        </p>
      ...
      <div className="mx-auto mt-16 max-w-5xl space-y-10">
        <section className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm sm:p-10">
          <h2 className="text-2xl font-semibold tracking-tight text-slate-900 sm:text-3xl">
            The real fight in Frisco isn’t traffic—it’s intent
          </h2>
        ...
        <section className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm sm:p-10">
          ...
          <p className="mt-4 text-base leading-relaxed text-slate-600">
            We start with clarity and economics: which searches produce profitable jobs, which
            pages should win them, and what has to be true for a homeowner to take action.
          </p>
        ...
        <section className="rounded-3xl border border-slate-200 bg-white px-8 py-10 text-center shadow-sm">
          <h2 className="text-2xl font-semibold tracking-tight text-slate-900 sm:text-3xl">
            Want a simple, specific plan for Frisco?
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-base leading-relaxed text-slate-600">
            Start with the Growth Plan. You’ll walk away knowing what to fix, what to build, and
            what will actually move calls and booked jobs.
          </p>
