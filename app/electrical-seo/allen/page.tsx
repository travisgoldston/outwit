...
export const metadata: Metadata = {
  title: "Outwit — Electrical SEO in Allen",
  description:
    "Electrical SEO in Allen for contractors who want more inbound calls and booked jobs from high-intent local search. Start with the Outwit Growth Plan.",
};

export default function ElectricalSeoAllenPage() {
  return (
    <div className="bg-[#FAFAFA] px-6 py-16 text-slate-900 lg:px-8 lg:py-24">
      <div className="mx-auto max-w-4xl text-center">
        <h1 className="text-4xl font-bold tracking-tight text-slate-900 sm:text-5xl">
          Electrical SEO in Allen: get found when homeowners need an electrician now.
        </h1>
        <p className="mx-auto mt-6 max-w-3xl text-lg leading-relaxed text-slate-600">
          Outwit helps Allen electrical contractors capture high-intent searches and convert them into
          calls—without relying on generic agency “deliverables.”
        </p>
      ...
      <div className="mx-auto mt-16 max-w-5xl space-y-10">
        <section className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm sm:p-10">
          <h2 className="text-2xl font-semibold tracking-tight text-slate-900 sm:text-3xl">
            What we build for Allen electricians
          </h2>
        ...
        <section className="rounded-3xl border border-slate-200 bg-white px-8 py-10 text-center shadow-sm">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base leading-relaxed text-slate-600">
            The Growth Plan maps exactly what to fix and what to build in Allen so search becomes
